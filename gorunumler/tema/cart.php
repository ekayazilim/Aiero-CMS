...
<head>
    ...
    <title>Cart || Aiero AI Agency & Technology HTML Template</title>
    ...
    <section class="cart-sec ibt-section-gap">
        <div class="container">
                        ...
                        <tr>
                            <td>
                                <div class="product-block">
                                    <a href='shop-single.htm'><img src="assets/images/event/product1-1.png"
                            ...
                            <td>
                                <a href="#" title="" class="close-btn2">
                                    <img src="assets/images/icon/cross.svg" alt="AI Agency & Technology HTML Template">
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="product-block">
                                    <a href='shop-single.htm'><img src="assets/images/event/product1-2.png"
                                            alt="AI Agency & Technology HTML Template"></a>
                                    <h4 class="title"><a href='shop-single.htm'>Evening shoes</a></h4>
                                    <ul class="rating">
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="cart-table2">
                ...
                <a class='ibt-btn ibt-btn-dark' href='checkout.htm' title="">
