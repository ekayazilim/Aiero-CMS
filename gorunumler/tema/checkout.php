...
<head>
    ...
    <title>Checkout || Aiero AI Agency & Technology HTML Template</title>
                    ...
                    <div class="contact-form5">
                        <form action="#" method="post" class="custom-form5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="text" placeholder="House number and street name"
                                            required="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <table class="mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="recent-post3">
                                                <a href='shop-single.htm'><img src="assets/images/event/post3-1.png"
                                                        alt="AI Agency & Technology HTML Template"></a>
                                                <h4 class="title"><a href='shop-single.htm'>Sneakers RED XL</a></h4>
                                                <ul class="rating">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="recent-post3">
                                                <a href='shop-single.htm'><img src="assets/images/event/post3-2.png"
                                                        alt="AI Agency & Technology HTML Template"></a>
